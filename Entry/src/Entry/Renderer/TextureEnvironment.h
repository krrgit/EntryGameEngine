...
namespace Entry
{
	...
	static TexEnvProps s_TexEnvLitProps[6]
	{
		{
			// RGB
			ET_RGBA_Separate, ET_GPU_MODULATE, ET_GPU_TEXTURE0, ET_GPU_FRAGMENT_PRIMARY_COLOR, ET_GPU_FRAGMENT_SECONDARY_COLOR,
			// Alpha
			ET_GPU_REPLACE, ET_GPU_TEXTURE0, ET_GPU_PRIMARY_COLOR, ET_GPU_PRIMARY_COLOR
		},
		{
			// RGB
			ET_RGBA_Separate, ET_GPU_ADD, ET_GPU_PREVIOUS, ET_GPU_FRAGMENT_SECONDARY_COLOR, ET_GPU_FRAGMENT_PRIMARY_COLOR,
			// Alpha
			ET_GPU_REPLACE, ET_GPU_TEXTURE0, ET_GPU_PRIMARY_COLOR, ET_GPU_PRIMARY_COLOR
		}
	};
